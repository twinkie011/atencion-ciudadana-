...
<main class="container">
  <section class="detalle-apoyo">
    <h2><i class="fas fa-hand-holding-usd"></i> Apoyo Económico Directo</h2>

    <!-- Aquí se mostrarían los detalles del apoyo -->
    <p>El <strong>Apoyo Económico Directo</strong> está dirigido a familias en situación vulnerable. Proporciona un subsidio financiero para cubrir necesidades básicas durante tiempos de crisis.</p>
    ...
    <p>Para solicitar este apoyo, debes acudir a la oficina de atención ciudadana o registrarte en el portal web oficial. Se evaluará tu situación y, de ser aprobado, recibirás el subsidio en un plazo de 30 días hábiles.</p>
